...
const CarEntry CableLaunchVehicles[4] = {
    {
    /* .TabRotationMask = */ 31,
    /* .spacing = */ 0,
    /* .car_mass = */ 0,
    ...
    /* .flags = */ 0,
    /* .base_num_frames = */ 1,
    /* .base_image_id = */ SPR_G2_CATCH_CAR_BEGIN,
    /* .SpriteGroups[SlopeFlat] = */ SPR_G2_CATCH_CAR_BEGIN, SpritePrecision::Sprites4,
    /* .SpriteGroups[Slopes12] = */ 0, SpritePrecision::Sprites4,
    /* .SpriteGroups[Slopes25] = */ 0, SpritePrecision::Sprites32,
    /* .SpriteGroups[Slopes42] = */ 0, SpritePrecision::Sprites8,
    /* .SpriteGroups[Slopes60] = */ 0, SpritePrecision::Sprites32,
    /* .SpriteGroups[Slopes75] = */ 0, SpritePrecision::None,
    /* .SpriteGroups[Slopes90] = */ 0, SpritePrecision::None,
    /* .SpriteGroups[SlopesLoop] = */ 0, SpritePrecision::None,
    /* .SpriteGroups[SlopeInverted] = */ 0, SpritePrecision::None,
    ...
    /* .flags = */ 0,
    /* .base_num_frames = */ 1,
    /* .base_image_id = */ SPR_G2_CATCH_CAR_BEGIN+4,
    /* .SpriteGroups[SlopeFlat] = */ SPR_G2_CATCH_CAR_BEGIN+4, SpritePrecision::Sprites4,
    /* .SpriteGroups[Slopes12] = */ 0, SpritePrecision::Sprites4,
    /* .SpriteGroups[Slopes25] = */ 0, SpritePrecision::Sprites32,
    /* .SpriteGroups[Slopes42] = */ 0, SpritePrecision::Sprites8,
    /* .SpriteGroups[Slopes60] = */ 0, SpritePrecision::Sprites32,
    ...
    /* .base_num_frames = */ 1,
    /* .base_image_id = */ SPR_G2_CATCH_CAR_BEGIN+4,
    /* .SpriteGroups[SlopeFlat] = */ SPR_G2_CATCH_CAR_BEGIN+8, SpritePrecision::Sprites4,
    /* .SpriteGroups[Slopes12] = */ 0, SpritePrecision::Sprites4,
    /* .SpriteGroups[Slopes25] = */ 0, SpritePrecision::Sprites32,
    /* .SpriteGroups[Slopes42] = */ 0, SpritePrecision::Sprites8,
    /* .SpriteGroups[Slopes60] = */ 0, SpritePrecision::Sprites32,
    ...
    /* .base_num_frames = */ 1,
    /* .base_image_id = */ SPR_G2_CATCH_CAR_BEGIN+4,
    /* .SpriteGroups[SlopeFlat] = */ SPR_G2_CATCH_CAR_BEGIN+12, SpritePrecision::Sprites4,
    /* .SpriteGroups[Slopes12] = */ 0, SpritePrecision::Sprites4,
    /* .SpriteGroups[Slopes25] = */ 0, SpritePrecision::Sprites32,
    /* .SpriteGroups[Slopes42] = */ 0, SpritePrecision::Sprites8,
    /* .SpriteGroups[Slopes60] = */ 0, SpritePrecision::Sprites32,
