...
// clang-format off
constexpr RideTypeDescriptor PipelineCoasterRTD =
{
    .Category = RIDE_CATEGORY_ROLLERCOASTER,
    .StartTrackPiece = OpenRCT2::TrackElemType::EndStation,
    .TrackPaintFunctions = TrackDrawerDescriptor({
        .Drawer = PipelineRC::GetTrackPaintFunction,
        .supportType = MetalSupportType::Tubes,
        .EnabledTrackPieces = { TrackGroup::flat, TrackGroup::straight, TrackGroup::stationEnd, TrackGroup::liftHill, TrackGroup::flatRollBanking, TrackGroup::slope, TrackGroup::slopeLong, TrackGroup::slopeSteepLong, TrackGroup::slopeSteepUp, TrackGroup::slopeSteepDown, TrackGroup::slopeCurve, TrackGroup::slopeCurveSteep, TrackGroup::sBend, TrackGroup::curveSmall, TrackGroup::curve, TrackGroup::curveLarge, TrackGroup::helixDownBankedHalf, TrackGroup::helixUpBankedHalf, TrackGroup::brakes, TrackGroup::onridePhoto, TrackGroup::blockBrakes, TrackGroup::twist, TrackGroup::halfLoop, TrackGroup::slopeCurveLarge, TrackGroup::diagBrakes, TrackGroup::diagBlockBrakes, TrackGroup::slopeCurveBanked},
        .ExtraTrackPieces =  {},
    }),
    ...
    .Naming = { STR_RIDE_NAME_PIPELINE_COASTER, STR_RIDE_DESCRIPTION_PIPELINE_COASTER },
    .NameConvention = { RideComponentType::Train, RideComponentType::Track, RideComponentType::Station },
    .EnumName = "RIDE_TYPE_PIPELINE_COASTER",
    .AvailableBreakdowns = (1 << BREAKDOWN_SAFETY_CUT_OUT) | (1 << BREAKDOWN_RESTRAINTS_STUCK_CLOSED) | (1 << BREAKDOWN_RESTRAINTS_STUCK_OPEN) | (1 << BREAKDOWN_VEHICLE_MALFUNCTION) | (1 << BREAKDOWN_BRAKES_FAILURE),
    .Heights = { 26, 24, 15, 16},
    .MaxMass = 18,
    .LiftData = { OpenRCT2::Audio::SoundId::LiftArrow, 5, 6 },
    ...
    .ColourPresets = TRACK_COLOUR_PRESETS(
        { COLOUR_WHITE, COLOUR_WHITE, COLOUR_GREY },
        { COLOUR_YELLOW, COLOUR_WHITE, COLOUR_BLACK },
        { COLOUR_LIGHT_BLUE, COLOUR_WHITE, COLOUR_WHITE }
    ),
    ...
    .RatingsData = 
    {
        ...
        { RIDE_RATING(3, 00), RIDE_RATING(0, 70), RIDE_RATING(0, 50) },
        18,
        -1,
        true,
        {
            ...
            { RatingsModifierType::BonusReversedTrains,   0,                2, 15, 25 },//Not set
