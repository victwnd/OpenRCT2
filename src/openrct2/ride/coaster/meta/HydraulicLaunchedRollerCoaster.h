...
constexpr RideTypeDescriptor HydraulicLaunchedRollerCoasterRTD =
{
    ...
    .Flags = RIDE_TYPE_FLAGS_TRACK_HAS_3_COLOURS | RIDE_TYPE_FLAG_HAS_TRACK_COLOUR_SUPPORTS | RIDE_TYPE_FLAG_HAS_LEAVE_WHEN_ANOTHER_VEHICLE_ARRIVES_AT_STATION |
                     ...
                     RIDE_TYPE_FLAG_ALLOW_REVERSED_TRAINS | RIDE_TYPE_FLAG_HAS_ALTERNATE_TRACK | RIDE_TYPE_FLAG_ALLOW_CABLE_LAUNCH,
    ...
    .EnumName = nameof(RIDE_TYPE_HYDRAULIC_LAUNCHED_ROLLER_COASTER),
...
constexpr RideTypeDescriptor HydraulicLaunchedRollerCoasterAlt1RTD =
{
    ...
    .StartTrackPiece = TrackElemType::EndStation,
    .TrackPaintFunctions = TrackDrawerDescriptor({
        .Drawer = HydraulicLaunchedRC::GetTrackPaintFunctionAlt1,
...
constexpr const RideTypeDescriptor HydraulicLaunchedRollerCoasterAlt2RTD =
{
    ...
    .StartTrackPiece = TrackElemType::EndStation,
    .TrackPaintFunctions = TrackDrawerDescriptor({
        .Drawer = HydraulicLaunchedRC::GetTrackPaintFunctionAlt2,
