...
enum
{
    ...
    SPR_G2_ARROW_DOWN,
    SPR_G2_RELOAD,
    SPR_RIDE_CONSTRUCTION_BI_RAIL_TRACK,
    SPR_RIDE_CONSTRUCTION_TRI_RAIL_TRACK,
    SPR_RIDE_CONSTRUCTION_QUAD_RAIL_TRACK,
    ...
    SPR_G2_MINETRAIN_RC_END = SPR_G2_MINETRAIN_DIAG_BRAKES + 6,

    SPR_G2_STANDUP_RC_BEGIN = SPR_G2_MINETRAIN_RC_END,
    SPR_G2_STANDUP_DIAG_BRAKES = SPR_G2_STANDUP_RC_BEGIN,
    SPR_G2_STANDUP_RC_END = SPR_G2_STANDUP_DIAG_BRAKES + 6,
    ...
    SPR_G2_CORKSCREW_RC_END = SPR_G2_CORKSCREW_DIAG_BRAKES + 6,
    ...
    SPR_G2_SINGLE_RAIL_LIFT_BEGIN = SPR_G2_SINGLE_RAIL_TRACK_GENTLE_LARGE_CURVE_BANKED + 128,
    ...
    SPR_RIDE_DESIGN_PREVIEW_HYDRAULIC_LAUNCHED_ROLLER_COASTER_TRACK = SPR_G2_ICON_MEDIUM_CURVE_RIGHT + 1,
    SPR_RIDE_DESIGN_PREVIEW_HYDRAULIC_LAUNCHED_ROLLER_COASTER_SUPPORTS
    = SPR_RIDE_DESIGN_PREVIEW_HYDRAULIC_LAUNCHED_ROLLER_COASTER_TRACK + 1,
    SPR_G2_HYDRAULIC_LAUNCHED_BEGIN = SPR_RIDE_DESIGN_PREVIEW_HYDRAULIC_LAUNCHED_ROLLER_COASTER_TRACK + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_FLAT = SPR_G2_HYDRAULIC_LAUNCHED_BEGIN,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_FLAT + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_STEEP = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE + 12,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_VERTICAL = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_STEEP + 16,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_SMALL_CURVE = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_VERTICAL + 12,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MEDIUM_CURVE = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_SMALL_CURVE + 12,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_LARGE_CURVE = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MEDIUM_CURVE + 20,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_FLAT_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_LARGE_CURVE + 32,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_FLAT_DIAGONAL + 4,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_STEEP_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_DIAGONAL + 12,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BANK_TRANSITION = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_STEEP_DIAGONAL + 12,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BANK_TRANSITION_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BANK_TRANSITION + 40,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_SMALL_CURVE_BANKED = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BANK_TRANSITION_DIAGONAL + 34,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MEDIUM_CURVE_BANKED = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_SMALL_CURVE_BANKED + 14,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_LARGE_CURVE_BANKED = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MEDIUM_CURVE_BANKED + 22,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_SMALL_CURVE = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_LARGE_CURVE_BANKED + 32,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_MEDIUM_CURVE = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_SMALL_CURVE + 16,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_STEEP_SMALL_CURVE = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_MEDIUM_CURVE + 40,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_VERTICAL_TWIST = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_STEEP_SMALL_CURVE + 16,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_SLOPE_BANK_TRANSITION = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_VERTICAL_TWIST + 12,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_SMALL_CURVE_BANKED = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_SLOPE_BANK_TRANSITION + 64,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_MEDIUM_CURVE_BANKED = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_SMALL_CURVE_BANKED + 16,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_S_BEND = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_MEDIUM_CURVE_BANKED + 40,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_SMALL_HELIX = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_S_BEND + 16,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_LARGE_HELIX = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_SMALL_HELIX + 28,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BARREL_ROLL = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_LARGE_HELIX + 44,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_HALF_LOOP = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BARREL_ROLL + 48,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_FLAT_TO_STEEP = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_HALF_LOOP + 16,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_QUARTER_LOOP = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_FLAT_TO_STEEP + 32,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_CORKSCREW = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_QUARTER_LOOP + 12,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_LARGE_CORKSCREW = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_CORKSCREW + 24,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_TURN_BANK_TRANSITION = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_LARGE_CORKSCREW + 40,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MEDIUM_HALF_LOOP = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_TURN_BANK_TRANSITION + 18,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_LARGE_HALF_LOOP = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MEDIUM_HALF_LOOP + 40,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_ZERO_G_ROLL = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_LARGE_HALF_LOOP + 56,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_LARGE_ZERO_G_ROLL = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_ZERO_G_ROLL + 32,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_SMALL_FLAT_TO_STEEP = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_LARGE_ZERO_G_ROLL + 40,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_LARGE_CURVE = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_SMALL_FLAT_TO_STEEP + 20,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_LARGE_CURVE_BANKED = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_LARGE_CURVE + 64,
    SPR_G2_HYDRAULIC_LAUNCHED_LIFT_BEGIN = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_GENTLE_LARGE_CURVE_BANKED + 128,
    SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_FLAT = SPR_G2_HYDRAULIC_LAUNCHED_LIFT_BEGIN,
    SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_GENTLE = SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_FLAT + 4,
    SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_STEEP = SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_GENTLE + 12,
    SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_FLAT_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_STEEP + 16,
    SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_GENTLE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_FLAT_DIAGONAL + 4,
    SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_STEEP_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_GENTLE_DIAGONAL + 12,
    SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_SMALL_FLAT_TO_STEEP = SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_STEEP_DIAGONAL + 12,

    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BRAKE = SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 20,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BRAKE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BRAKE + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BLOCK_BRAKE = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BRAKE_DIAGONAL + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BLOCK_BRAKE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BLOCK_BRAKE + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_BLOCK_BRAKE_DIAGONAL + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE_GENTLE = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE + 2, 
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE_GENTLE + 4,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE_GENTLE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE_DIAGONAL + 2,
 
    SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_BRAKE = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE_GENTLE_DIAGONAL + 4,
    SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_BRAKE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_BRAKE + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_BLOCK_BRAKE = SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_BRAKE_DIAGONAL + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_BLOCK_BRAKE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_BLOCK_BRAKE + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE = SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_BLOCK_BRAKE_DIAGONAL + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE_GENTLE = SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE + 2, 
    SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE_GENTLE + 4,
    SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE_GENTLE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE_DIAGONAL + 2,
 
    SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_BRAKE = SPR_G2_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE_GENTLE_DIAGONAL + 4,
    SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_BRAKE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_BRAKE + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_BLOCK_BRAKE = SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_BRAKE_DIAGONAL + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_BLOCK_BRAKE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_BLOCK_BRAKE + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE = SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_BLOCK_BRAKE_DIAGONAL + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE_GENTLE = SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE + 2, 
    SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE_GENTLE + 4,
    SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE_GENTLE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE_DIAGONAL + 2,

    // Cable launch catch car
    SPR_G2_CATCH_CAR_BEGIN = SPR_G2_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE_GENTLE_DIAGONAL + 4,
    SPR_G2_CATCH_CAR_END = SPR_G2_CATCH_CAR_BEGIN + 16,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_CABLE_LAUNCH = SPR_G2_CATCH_CAR_END,
    SPR_G2_HYDRAULIC_LAUNCHED_END = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_CABLE_LAUNCH + 16,

    SPR_G2_END = SPR_G2_HYDRAULIC_LAUNCHED_END,
