...
enum
{
    ...
    SPR_G2_TAB_LAND = SPR_G2_BEGIN + 5,

    SPR_G2_PLACEHOLDER = SPR_G2_BEGIN + 6,

    SPR_G2_ZOOM_IN = SPR_G2_BEGIN + 7,
    SPR_G2_ZOOM_IN_DISABLED = SPR_G2_BEGIN + 8,
    SPR_G2_ZOOM_OUT = SPR_G2_BEGIN + 9,
    SPR_G2_ZOOM_OUT_DISABLED = SPR_G2_BEGIN + 10,

    SPR_G2_TAB_TREE = SPR_G2_BEGIN + 11,
    SPR_G2_TAB_PENCIL = SPR_G2_BEGIN + 12,
    SPR_G2_BUTTON_LARGE_SCENERY = SPR_G2_BEGIN + 13,
    SPR_G2_BUTTON_TREES = SPR_G2_BEGIN + 14,
    SPR_G2_BUTTON_FOOTPATH = SPR_G2_BEGIN + 15,

    SPR_G2_RCT1_CLOSE_BUTTON_0 = SPR_G2_BEGIN + 16,
    SPR_G2_RCT1_CLOSE_BUTTON_1 = SPR_G2_BEGIN + 17,
    SPR_G2_RCT1_CLOSE_BUTTON_2 = SPR_G2_BEGIN + 18,
    SPR_G2_RCT1_CLOSE_BUTTON_3 = SPR_G2_BEGIN + 19,
    SPR_G2_RCT1_TEST_BUTTON_0 = SPR_G2_BEGIN + 20,
    SPR_G2_RCT1_TEST_BUTTON_1 = SPR_G2_BEGIN + 21,
    SPR_G2_RCT1_TEST_BUTTON_2 = SPR_G2_BEGIN + 22,
    SPR_G2_RCT1_TEST_BUTTON_3 = SPR_G2_BEGIN + 23,
    SPR_G2_RCT1_OPEN_BUTTON_0 = SPR_G2_BEGIN + 24,
    SPR_G2_RCT1_OPEN_BUTTON_1 = SPR_G2_BEGIN + 25,
    SPR_G2_RCT1_OPEN_BUTTON_2 = SPR_G2_BEGIN + 26,
    SPR_G2_RCT1_OPEN_BUTTON_3 = SPR_G2_BEGIN + 27,

    SPR_G2_TITLE_RESTART = SPR_G2_BEGIN + 28,
    SPR_G2_TITLE_STOP = SPR_G2_BEGIN + 29,
    SPR_G2_TITLE_PLAY = SPR_G2_BEGIN + 30,
    SPR_G2_TITLE_SKIP = SPR_G2_BEGIN + 31,

    SPR_G2_SANDBOX = SPR_G2_BEGIN + 32,

    SPR_G2_TAB_NEWS = SPR_G2_BEGIN + 57,
    SPR_G2_LOCKED = SPR_G2_BEGIN + 58,
    SPR_G2_MENU_MULTIPLAYER = SPR_G2_BEGIN + 59,

    SPR_G2_SORT = SPR_G2_BEGIN + 76,
    SPR_G2_COPY = SPR_G2_BEGIN + 77,
    SPR_G2_PASTE = SPR_G2_BEGIN + 78,

    SPR_G2_GIGA_RC_BOOSTER_NE_SW = SPR_G2_BEGIN + 79,
    SPR_G2_GIGA_RC_BOOSTER_NW_SE = SPR_G2_BEGIN + 80,
    SPR_G2_BM_BOOSTER_NE_SW = SPR_G2_BEGIN + 81,
    SPR_G2_BM_BOOSTER_NW_SE = SPR_G2_BEGIN + 82,

    SPR_G2_TOOLBAR_MUTE = SPR_G2_BEGIN + 85,
    SPR_G2_TOOLBAR_MUTE_PRESSED = SPR_G2_BEGIN + 86,
    SPR_G2_TOOLBAR_UNMUTE = SPR_G2_BEGIN + 87,
    SPR_G2_TOOLBAR_UNMUTE_PRESSED = SPR_G2_BEGIN + 88,

    SPR_G2_MINI_RC_BOOSTER_NE_SW = SPR_G2_BEGIN + 89,
    SPR_G2_MINI_RC_BOOSTER_NW_SE = SPR_G2_BEGIN + 90,

    SPR_G2_MINIATURE_RAILWAY_QUARTER_TURN_3_TILES_SW_SE_PART_3 = SPR_G2_BEGIN + 91,

    SPR_G2_MINIATURE_RAILWAY_BEGIN = SPR_G2_BEGIN + 92,
    ...
    SPR_G2_MINIATURE_RAILWAY_LAST = SPR_G2_BEGIN + 103,

    SPR_G2_SEARCH = SPR_G2_BEGIN + 104,

    SPR_G2_SURFACE_GLASSY_RECOLOURABLE = SPR_G2_BEGIN + 105,

    SPR_G2_SELECTION_EDGE_NW = SPR_G2_BEGIN + 106,
    SPR_G2_SELECTION_EDGE_NE = SPR_G2_BEGIN + 107,
    SPR_G2_SELECTION_EDGE_SW = SPR_G2_BEGIN + 108,
    SPR_G2_SELECTION_EDGE_SE = SPR_G2_BEGIN + 109,

    SPR_G2_EYEDROPPER = SPR_G2_BEGIN + 110,
    SPR_G2_CHAT = SPR_G2_BEGIN + 111,

    SPR_G2_MAP_NORTH = SPR_G2_BEGIN + 112,
    SPR_G2_MAP_NORTH_PRESSED = SPR_G2_BEGIN + 113,
    SPR_G2_MAP_WEST = SPR_G2_BEGIN + 114,
    SPR_G2_MAP_WEST_PRESSED = SPR_G2_BEGIN + 115,
    SPR_G2_MAP_SOUTH = SPR_G2_BEGIN + 116,
    SPR_G2_MAP_SOUTH_PRESSED = SPR_G2_BEGIN + 117,
    SPR_G2_MAP_EAST = SPR_G2_BEGIN + 118,
    SPR_G2_MAP_EAST_PRESSED = SPR_G2_BEGIN + 119,

    SPR_G2_TOOLBAR_MULTIPLAYER = SPR_G2_BEGIN + 120,
    SPR_G2_TOOLBAR_MULTIPLAYER_PRESSED = SPR_G2_BEGIN + 121,
    SPR_G2_MULTIPLAYER_SYNC = SPR_G2_BEGIN + 122,
    SPR_G2_MULTIPLAYER_DESYNC = SPR_G2_BEGIN + 123,

    SPR_G2_SIMULATE = SPR_G2_BEGIN + 124,
    SPR_G2_RCT1_SIMULATE_BUTTON_0 = SPR_G2_BEGIN + 125,
    SPR_G2_RCT1_SIMULATE_BUTTON_1 = SPR_G2_BEGIN + 126,
    SPR_G2_RCT1_SIMULATE_BUTTON_2 = SPR_G2_BEGIN + 127,
    SPR_G2_RCT1_SIMULATE_BUTTON_3 = SPR_G2_BEGIN + 128,

    SPR_G2_LAND_TOOL_SIZE_6 = SPR_G2_BEGIN + 129,

    SPR_G2_MOUNTAIN_TOOL_EVEN = SPR_G2_BEGIN + 130,
    SPR_G2_MOUNTAIN_TOOL_ODD = SPR_G2_BEGIN + 131,

    SPR_G2_SCENERY_SCATTER_LOW = SPR_G2_BEGIN + 132,
    SPR_G2_SCENERY_SCATTER_MEDIUM = SPR_G2_BEGIN + 133,
    SPR_G2_SCENERY_SCATTER_HIGH = SPR_G2_BEGIN + 134,
    ...
    SPR_G2_HYBRID_TRACK_BRAKE = SPR_G2_HYBRID_BEGIN + 2,
    SPR_G2_HYBRID_TRACK_BLOCK_BRAKE = SPR_G2_HYBRID_BEGIN + 4,
    SPR_G2_HYBRID_TRACK_BOOSTER = SPR_G2_HYBRID_BEGIN + 6,
    SPR_G2_HYBRID_TRACK_GENTLE = SPR_G2_HYBRID_BEGIN + 8,
    SPR_G2_HYBRID_TRACK_STEEP = SPR_G2_HYBRID_BEGIN + 20,
    SPR_G2_HYBRID_TRACK_VERTICAL = SPR_G2_HYBRID_BEGIN + 36,
    SPR_G2_HYBRID_TRACK_SMALL_CURVE = SPR_G2_HYBRID_BEGIN + 48,
    SPR_G2_HYBRID_TRACK_MEDIUM_CURVE = SPR_G2_HYBRID_BEGIN + 60,
    SPR_G2_HYBRID_TRACK_LARGE_CURVE = SPR_G2_HYBRID_BEGIN + 80,
    SPR_G2_HYBRID_TRACK_FLAT_DIAGONAL = SPR_G2_HYBRID_BEGIN + 112,
    SPR_G2_HYBRID_TRACK_GENTLE_DIAGONAL = SPR_G2_HYBRID_BEGIN + 116,
    SPR_G2_HYBRID_TRACK_STEEP_DIAGONAL = SPR_G2_HYBRID_BEGIN + 128,
    SPR_G2_HYBRID_TRACK_BANK_TRANSITION = SPR_G2_HYBRID_BEGIN + 140,
    SPR_G2_HYBRID_TRACK_BANK_TRANSITION_DIAGONAL = SPR_G2_HYBRID_BEGIN + 182,
    SPR_G2_HYBRID_TRACK_SMALL_CURVE_BANKED = SPR_G2_HYBRID_BEGIN + 217,
    SPR_G2_HYBRID_TRACK_MEDIUM_CURVE_BANKED = SPR_G2_HYBRID_BEGIN + 233,
    SPR_G2_HYBRID_TRACK_LARGE_CURVE_BANKED = SPR_G2_HYBRID_BEGIN + 258,
    SPR_G2_HYBRID_TRACK_GENTLE_SMALL_CURVE = SPR_G2_HYBRID_BEGIN + 298,
    SPR_G2_HYBRID_TRACK_GENTLE_MEDIUM_CURVE = SPR_G2_HYBRID_BEGIN + 314,
    SPR_G2_HYBRID_TRACK_STEEP_SMALL_CURVE = SPR_G2_HYBRID_BEGIN + 354,
    SPR_G2_HYBRID_TRACK_VERTICAL_TWIST = SPR_G2_HYBRID_BEGIN + 370,
    SPR_G2_HYBRID_TRACK_SLOPE_BANK_TRANSITION = SPR_G2_HYBRID_BEGIN + 382,
    SPR_G2_HYBRID_TRACK_GENTLE_SMALL_CURVE_BANKED = SPR_G2_HYBRID_BEGIN + 454,
    SPR_G2_HYBRID_TRACK_GENTLE_MEDIUM_CURVE_BANKED = SPR_G2_HYBRID_BEGIN + 476,
    SPR_G2_HYBRID_TRACK_S_BEND = SPR_G2_HYBRID_BEGIN + 528,
    SPR_G2_HYBRID_TRACK_SMALL_HELIX = SPR_G2_HYBRID_BEGIN + 544,
    SPR_G2_HYBRID_TRACK_LARGE_HELIX = SPR_G2_HYBRID_BEGIN + 576,
    SPR_G2_HYBRID_TRACK_BARREL_ROLL = SPR_G2_HYBRID_BEGIN + 626,
    SPR_G2_HYBRID_TRACK_FLAT_TO_STEEP = SPR_G2_HYBRID_BEGIN + 674,
    SPR_G2_HYBRID_TRACK_QUARTER_LOOP = SPR_G2_HYBRID_BEGIN + 706,
    SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION = SPR_G2_HYBRID_BEGIN + 730,
    SPR_G2_HYBRID_TRACK_POWERED_LIFT = SPR_G2_HYBRID_BEGIN + 748,
    SPR_G2_HYBRID_LIFT_BEGIN = SPR_G2_HYBRID_BEGIN + 752,
    SPR_G2_HYBRID_LIFT_TRACK_FLAT = SPR_G2_HYBRID_LIFT_BEGIN,
    SPR_G2_HYBRID_LIFT_TRACK_GENTLE = SPR_G2_HYBRID_LIFT_BEGIN + 4,
    SPR_G2_HYBRID_LIFT_TRACK_STEEP = SPR_G2_HYBRID_LIFT_BEGIN + 16,
    SPR_G2_HYBRID_LIFT_TRACK_FLAT_DIAGONAL = SPR_G2_HYBRID_LIFT_BEGIN + 32,
    SPR_G2_HYBRID_LIFT_TRACK_GENTLE_DIAGONAL = SPR_G2_HYBRID_LIFT_BEGIN + 36,
    SPR_G2_HYBRID_LIFT_TRACK_STEEP_DIAGONAL = SPR_G2_HYBRID_LIFT_BEGIN + 48,
    SPR_G2_HYBRID_END = SPR_G2_HYBRID_LIFT_BEGIN + 60,
    ...
    SPR_G2_SINGLE_RAIL_TRACK_BRAKE = SPR_G2_SINGLE_RAIL_BEGIN + 2,
    SPR_G2_SINGLE_RAIL_TRACK_BLOCK_BRAKE = SPR_G2_SINGLE_RAIL_BEGIN + 4,
    SPR_G2_SINGLE_RAIL_TRACK_GENTLE = SPR_G2_SINGLE_RAIL_BEGIN + 6,
    SPR_G2_SINGLE_RAIL_TRACK_STEEP = SPR_G2_SINGLE_RAIL_BEGIN + 18,
    SPR_G2_SINGLE_RAIL_TRACK_VERTICAL = SPR_G2_SINGLE_RAIL_BEGIN + 34,
    SPR_G2_SINGLE_RAIL_TRACK_SMALL_CURVE = SPR_G2_SINGLE_RAIL_BEGIN + 46,
    SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE = SPR_G2_SINGLE_RAIL_BEGIN + 58,
    SPR_G2_SINGLE_RAIL_TRACK_LARGE_CURVE = SPR_G2_SINGLE_RAIL_BEGIN + 78,
    SPR_G2_SINGLE_RAIL_TRACK_FLAT_DIAGONAL = SPR_G2_SINGLE_RAIL_BEGIN + 110,
    SPR_G2_SINGLE_RAIL_TRACK_GENTLE_DIAGONAL = SPR_G2_SINGLE_RAIL_BEGIN + 114,
    SPR_G2_SINGLE_RAIL_TRACK_STEEP_DIAGONAL = SPR_G2_SINGLE_RAIL_BEGIN + 126,
    SPR_G2_SINGLE_RAIL_TRACK_BANK_TRANSITION = SPR_G2_SINGLE_RAIL_BEGIN + 138,
    SPR_G2_SINGLE_RAIL_TRACK_BANK_TRANSITION_DIAGONAL = SPR_G2_SINGLE_RAIL_BEGIN + 178,
    SPR_G2_SINGLE_RAIL_TRACK_SMALL_CURVE_BANKED = SPR_G2_SINGLE_RAIL_BEGIN + 212,
    SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED = SPR_G2_SINGLE_RAIL_BEGIN + 226,
    SPR_G2_SINGLE_RAIL_TRACK_LARGE_CURVE_BANKED = SPR_G2_SINGLE_RAIL_BEGIN + 248,
    SPR_G2_SINGLE_RAIL_TRACK_GENTLE_SMALL_CURVE = SPR_G2_SINGLE_RAIL_BEGIN + 280,
    SPR_G2_SINGLE_RAIL_TRACK_GENTLE_MEDIUM_CURVE = SPR_G2_SINGLE_RAIL_BEGIN + 296,
    SPR_G2_SINGLE_RAIL_TRACK_STEEP_SMALL_CURVE = SPR_G2_SINGLE_RAIL_BEGIN + 336,
    SPR_G2_SINGLE_RAIL_TRACK_VERTICAL_TWIST = SPR_G2_SINGLE_RAIL_BEGIN + 352,
    SPR_G2_SINGLE_RAIL_TRACK_SLOPE_BANK_TRANSITION = SPR_G2_SINGLE_RAIL_BEGIN + 364,
    SPR_G2_SINGLE_RAIL_TRACK_GENTLE_SMALL_CURVE_BANKED = SPR_G2_SINGLE_RAIL_BEGIN + 428,
    SPR_G2_SINGLE_RAIL_TRACK_GENTLE_MEDIUM_CURVE_BANKED = SPR_G2_SINGLE_RAIL_BEGIN + 444,
    SPR_G2_SINGLE_RAIL_TRACK_S_BEND = SPR_G2_SINGLE_RAIL_BEGIN + 484,
    SPR_G2_SINGLE_RAIL_TRACK_SMALL_HELIX = SPR_G2_SINGLE_RAIL_BEGIN + 500,
    SPR_G2_SINGLE_RAIL_TRACK_LARGE_HELIX = SPR_G2_SINGLE_RAIL_BEGIN + 528,
    SPR_G2_SINGLE_RAIL_TRACK_BARREL_ROLL = SPR_G2_SINGLE_RAIL_BEGIN + 572,
    SPR_G2_SINGLE_RAIL_TRACK_HALF_LOOP = SPR_G2_SINGLE_RAIL_BEGIN + 620,
    SPR_G2_SINGLE_RAIL_TRACK_FLAT_TO_STEEP = SPR_G2_SINGLE_RAIL_BEGIN + 636,
    SPR_G2_SINGLE_RAIL_TRACK_QUARTER_LOOP = SPR_G2_SINGLE_RAIL_BEGIN + 668,
    SPR_G2_SINGLE_RAIL_TRACK_CORKSCREW = SPR_G2_SINGLE_RAIL_BEGIN + 680,
    SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION = SPR_G2_SINGLE_RAIL_BEGIN + 704,
    SPR_G2_SINGLE_RAIL_TRACK_LARGE_HALF_LOOP = SPR_G2_SINGLE_RAIL_BEGIN + 722,
    SPR_G2_SINGLE_RAIL_TRACK_SMALL_FLAT_TO_STEEP = SPR_G2_SINGLE_RAIL_BEGIN + 778,
    SPR_G2_SINGLE_RAIL_LIFT_BEGIN = SPR_G2_SINGLE_RAIL_BEGIN + 798,
    SPR_G2_SINGLE_RAIL_LIFT_TRACK_FLAT = SPR_G2_SINGLE_RAIL_LIFT_BEGIN,
    SPR_G2_SINGLE_RAIL_LIFT_TRACK_GENTLE = SPR_G2_SINGLE_RAIL_LIFT_BEGIN + 4,
    SPR_G2_SINGLE_RAIL_LIFT_TRACK_STEEP = SPR_G2_SINGLE_RAIL_LIFT_BEGIN + 16,
    SPR_G2_SINGLE_RAIL_LIFT_TRACK_FLAT_DIAGONAL = SPR_G2_SINGLE_RAIL_LIFT_BEGIN + 32,
    SPR_G2_SINGLE_RAIL_LIFT_TRACK_GENTLE_DIAGONAL = SPR_G2_SINGLE_RAIL_LIFT_BEGIN + 36,
    SPR_G2_SINGLE_RAIL_LIFT_TRACK_STEEP_DIAGONAL = SPR_G2_SINGLE_RAIL_LIFT_BEGIN + 48,
    SPR_G2_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP = SPR_G2_SINGLE_RAIL_LIFT_BEGIN + 60,
    SPR_G2_SINGLE_RAIL_TRACK_LARGE_CORKSCREW = SPR_G2_SINGLE_RAIL_LIFT_BEGIN + 80,
    SPR_G2_SINGLE_RAIL_END = SPR_G2_SINGLE_RAIL_LIFT_BEGIN + 120,
