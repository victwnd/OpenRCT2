...
enum
{
    ...
    SPR_G2_HYBRID_TRACK_POWERED_LIFT = SPR_G2_HYBRID_BEGIN+730,

    SPR_G2_HYBRID_LIFT_BEGIN = SPR_G2_HYBRID_BEGIN+734,
    SPR_G2_HYBRID_LIFT_TRACK_FLAT = SPR_G2_HYBRID_LIFT_BEGIN,
    SPR_G2_HYBRID_LIFT_TRACK_GENTLE = SPR_G2_HYBRID_LIFT_BEGIN+2,
    SPR_G2_HYBRID_LIFT_TRACK_STEEP = SPR_G2_HYBRID_LIFT_BEGIN+14,
   
    SPR_G2_HYBRID_LIFT_TRACK_FLAT_DIAGONAL = SPR_G2_HYBRID_LIFT_BEGIN+30,
    SPR_G2_HYBRID_LIFT_TRACK_GENTLE_DIAGONAL = SPR_G2_HYBRID_LIFT_BEGIN+34,
    SPR_G2_HYBRID_LIFT_TRACK_STEEP_DIAGONAL = SPR_G2_HYBRID_LIFT_BEGIN+46,
    SPR_G2_HYBRID_END = SPR_G2_HYBRID_LIFT_BEGIN+58,
