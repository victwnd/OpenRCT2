...
enum
{
    ...
    SPR_G2_HYBRID_BEGIN = SPR_G2_SUPPORT_END,
    ...
    SPR_G2_HYBRID_TRACK_CORKSCREW = SPR_G2_HYBRID_BEGIN+730,

    SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION = SPR_G2_HYBRID_BEGIN+754,


    SPR_G2_HYBRID_TRACK_POWERED_LIFT = SPR_G2_HYBRID_BEGIN+772,


    SPR_G2_HYBRID_LIFT_BEGIN = SPR_G2_HYBRID_BEGIN+776,
    ...
    SPR_RIDE_DESIGN_PREVIEW_HYBRID_ROLLER_COASTER_TRACK = SPR_G2_PLACEHOLDER,    //TODO: make sprites for preview
    SPR_RIDE_DESIGN_PREVIEW_HYBRID_ROLLER_COASTER_SUPPORTS = SPR_G2_PLACEHOLDER,

    SPR_G2_END = SPR_G2_HYBRID_END,
