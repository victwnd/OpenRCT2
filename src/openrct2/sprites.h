...
enum
{
    ...
    SPR_AIR_POWERED_VERTICAL_BEGIN = SPR_G2_BEGIN+341,
    SPR_G2_AIR_POWERED_VERTICAL_TRACK_FLAT = SPR_AIR_POWERED_VERTICAL_BEGIN,
    SPR_G2_AIR_POWERED_VERTICAL_TRACK_GENTLE = SPR_AIR_POWERED_VERTICAL_BEGIN+8,
    SPR_G2_AIR_POWERED_VERTICAL_TRACK_STEEP = SPR_AIR_POWERED_VERTICAL_BEGIN+20,
    SPR_G2_AIR_POWERED_VERTICAL_TRACK_SMALL_CURVE = SPR_AIR_POWERED_VERTICAL_BEGIN+36,
    SPR_G2_AIR_POWERED_VERTICAL_TRACK_LARGE_CURVE = SPR_AIR_POWERED_VERTICAL_BEGIN+48,

    SPR_G2_AIR_POWERED_VERTICAL_TRACK_FLAT_DIAGONAL = SPR_AIR_POWERED_VERTICAL_BEGIN+80,
    SPR_G2_AIR_POWERED_VERTICAL_TRACK_GENTLE_DIAGONAL = SPR_AIR_POWERED_VERTICAL_BEGIN+84,
    SPR_G2_AIR_POWERED_VERTICAL_TRACK_STEEP_DIAGONAL = SPR_AIR_POWERED_VERTICAL_BEGIN+96,
    SPR_G2_AIR_POWERED_VERTICAL_TRACK_BANK_TRANSITION_DIAGONAL = SPR_AIR_POWERED_VERTICAL_BEGIN+108,
    SPR_G2_AIR_POWERED_VERTICAL_TRACK_SMALL_CURVE_BANKED = SPR_AIR_POWERED_VERTICAL_BEGIN+142,
    SPR_G2_AIR_POWERED_VERTICAL_TRACK_LARGE_CURVE_BANKED = SPR_AIR_POWERED_VERTICAL_BEGIN+156,
