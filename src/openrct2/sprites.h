...
enum : ImageIndex
{
    ...
    SPR_G2_LATTICE_TRIANGLE_TRACK_DRIVE_TYRE_NE_SW = SPR_G2_LATTICE_TRIANGLE_TRACK_DIAG_BRAKES + 6,
    ...
    SPR_G2_CORKSCREW_RC_END = SPR_G2_CORKSCREW_TRACK_LARGE_ZERO_G_ROLL + 58,
    ...
    SPR_G2_LATTICE_TRIANGLE_TRACK_FLAT_TO_STEEP_DIAGONAL = SPR_G2_SINGLE_RAIL_GENTLE_BRAKE + 4,
    SPR_G2_LATTICE_TRIANGLE_TRACK_DIVE_LOOP = SPR_G2_LATTICE_TRIANGLE_TRACK_FLAT_TO_STEEP_DIAGONAL + 24,
    SPR_G2_END = SPR_G2_LATTICE_TRIANGLE_TRACK_DIVE_LOOP + 24,
