...
enum
{
    ...
    SPR_HYBRID_BEGIN = SPR_G2_CHAR_END,
    SPR_G2_HYBRID_TRACK_FLAT = SPR_HYBRID_BEGIN,
    SPR_G2_HYBRID_TRACK_GENTLE = SPR_HYBRID_BEGIN+8,
    SPR_G2_HYBRID_TRACK_STEEP = SPR_HYBRID_BEGIN+20,
    SPR_G2_HYBRID_TRACK_VERTICAL = SPR_HYBRID_BEGIN+36,
    SPR_G2_HYBRID_TRACK_SMALL_CURVE = SPR_HYBRID_BEGIN+48,
    SPR_G2_HYBRID_TRACK_MEDIUM_CURVE = SPR_HYBRID_BEGIN+60,
    SPR_G2_HYBRID_TRACK_LARGE_CURVE = SPR_HYBRID_BEGIN+80,

    SPR_G2_HYBRID_TRACK_FLAT_DIAGONAL = SPR_HYBRID_BEGIN+112,
    SPR_G2_HYBRID_TRACK_GENTLE_DIAGONAL = SPR_HYBRID_BEGIN+116,
    SPR_G2_HYBRID_TRACK_STEEP_DIAGONAL = SPR_HYBRID_BEGIN+128,

    SPR_G2_HYBRID_TRACK_BANK_TRANSITION = SPR_HYBRID_BEGIN+140,
    SPR_G2_HYBRID_TRACK_BANK_TRANSITION_DIAGONAL = SPR_HYBRID_BEGIN+180,
    SPR_G2_HYBRID_TRACK_SMALL_CURVE_BANKED = SPR_HYBRID_BEGIN+214,
    SPR_G2_HYBRID_TRACK_MEDIUM_CURVE_BANKED = SPR_HYBRID_BEGIN+228,
    SPR_G2_HYBRID_TRACK_LARGE_CURVE_BANKED = SPR_HYBRID_BEGIN+250,

    SPR_G2_HYBRID_TRACK_GENTLE_SMALL_CURVE = SPR_HYBRID_BEGIN+282,
    SPR_G2_HYBRID_TRACK_GENTLE_MEDIUM_CURVE = SPR_HYBRID_BEGIN+298,
    SPR_G2_HYBRID_TRACK_STEEP_SMALL_CURVE = SPR_HYBRID_BEGIN+338,
    SPR_G2_HYBRID_TRACK_VERTICAL_TWIST = SPR_HYBRID_BEGIN+354,

    SPR_G2_HYBRID_TRACK_SLOPE_BANK_TRANSITION = SPR_HYBRID_BEGIN+366,
    SPR_G2_HYBRID_TRACK_GENTLE_SMALL_CURVE_BANKED = SPR_HYBRID_BEGIN+430,
    SPR_G2_HYBRID_TRACK_GENTLE_MEDIUM_CURVE_BANKED = SPR_HYBRID_BEGIN+446,
   
    SPR_G2_HYBRID_TRACK_S_BEND = SPR_HYBRID_BEGIN+486,
    SPR_G2_HYBRID_TRACK_SMALL_HELIX = SPR_HYBRID_BEGIN+502,
    SPR_G2_HYBRID_TRACK_LARGE_HELIX = SPR_HYBRID_BEGIN+530,

    SPR_G2_HYBRID_TRACK_BARREL_ROLL = SPR_HYBRID_BEGIN+634,
    SPR_G2_HYBRID_TRACK_HALF_LOOP = SPR_HYBRID_BEGIN+682,

    SPR_G2_HYBRID_TRACK_FLAT_TO_STEEP = SPR_HYBRID_BEGIN+698,
    SPR_G2_HYBRID_TRACK_QUARTER_LOOP = SPR_HYBRID_BEGIN+730,

    SPR_G2_HYBRID_LIFT_TRACK_FLAT = SPR_HYBRID_BEGIN+574,
    SPR_G2_HYBRID_LIFT_TRACK_GENTLE = SPR_HYBRID_BEGIN+578,
    SPR_G2_HYBRID_LIFT_TRACK_STEEP = SPR_HYBRID_BEGIN+590,
    
    SPR_G2_HYBRID_LIFT_TRACK_FLAT_DIAGONAL = SPR_HYBRID_BEGIN+606,
    SPR_G2_HYBRID_LIFT_TRACK_GENTLE_DIAGONAL = SPR_HYBRID_BEGIN+610,
    SPR_G2_HYBRID_LIFT_TRACK_STEEP_DIAGONAL = SPR_HYBRID_BEGIN+622,
    
    SPR_G2_END = SPR_HYBRID_BEGIN+742,
