...
enum
{
    ...
    SPR_G2_DIAG_BRAKES_START = SPR_G2_ALPINE_END,

    SPR_G2_JUNIOR_DIAG_BRAKES = SPR_G2_DIAG_BRAKES_START,
    SPR_G2_CORKSCREW_DIAG_BRAKES = SPR_G2_JUNIOR_DIAG_BRAKES + 6,
    SPR_G2_SLC_DIAG_BRAKES = SPR_G2_CORKSCREW_DIAG_BRAKES + 6,
    SPR_G2_MULTIDIM_UPRIGHT_DIAG_BRAKES = SPR_G2_SLC_DIAG_BRAKES + 3,
    SPR_G2_MULTIDIM_INVERTED_DIAG_BRAKES = SPR_G2_MULTIDIM_UPRIGHT_DIAG_BRAKES + 6,
    SPR_G2_STEEPLECHASE_DIAG_BRAKES = SPR_G2_MULTIDIM_INVERTED_DIAG_BRAKES + 5,
