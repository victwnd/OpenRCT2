...
enum
{
    ...
    SPR_G2_HYBRID_TRACK_SMALL_CURVE_BANKED = SPR_HYBRID_BEGIN,
    SPR_G2_HYBRID_TRACK_MEDIUM_CURVE_BANKED = SPR_HYBRID_BEGIN,
    SPR_G2_HYBRID_TRACK_LARGE_CURVE_BANKED = SPR_HYBRID_BEGIN,
