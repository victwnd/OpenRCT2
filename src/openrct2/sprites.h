...
enum
{
    ...
    SPR_G2_HYBRID_TRACK_BANK_TRANSITION = 123,
    SPR_G2_HYBRID_TRACK_SMALL_CURVE_BANK = 123,
    SPR_G2_HYBRID_TRACK_MEDIUM_CURVE_BANK = 123,
    SPR_G2_HYBRID_TRACK_LARGE_CURVE_BANK = 123,
