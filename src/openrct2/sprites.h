...
enum
{
    ...
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_CABLE_LAUNCH = SPR_G2_HYDRAULIC_LAUNCHED_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 20,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_CABLE_LAUNCH + 2,
    SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE_DIAGONAL = SPR_G2_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE + 4,
