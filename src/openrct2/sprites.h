...
enum : ImageIndex
{
    ...
    SPR_G2_PIPELINE_BEGIN = SPR_G2_ICON_MEDIUM_CURVE_RIGHT + 1,
    SPR_G2_PIPELINE_TRACK_FLAT = SPR_G2_PIPELINE_BEGIN,
    SPR_G2_PIPELINE_TRACK_BRAKE = SPR_G2_PIPELINE_TRACK_FLAT + 4,
    SPR_G2_PIPELINE_TRACK_BLOCK_BRAKE = SPR_G2_PIPELINE_TRACK_BRAKE + 4,
    SPR_G2_PIPELINE_TRACK_GENTLE = SPR_G2_PIPELINE_TRACK_BLOCK_BRAKE + 4,
    SPR_G2_PIPELINE_TRACK_STEEP = SPR_G2_PIPELINE_TRACK_GENTLE + 24,
    SPR_G2_PIPELINE_TRACK_SMALL_CURVE = SPR_G2_PIPELINE_TRACK_STEEP + 24,
    SPR_G2_PIPELINE_TRACK_MEDIUM_CURVE = SPR_G2_PIPELINE_TRACK_SMALL_CURVE + 24,
    SPR_G2_PIPELINE_TRACK_LARGE_CURVE = SPR_G2_PIPELINE_TRACK_MEDIUM_CURVE + 40,
    SPR_G2_PIPELINE_TRACK_FLAT_DIAGONAL = SPR_G2_PIPELINE_TRACK_LARGE_CURVE + 64,
    SPR_G2_PIPELINE_TRACK_BRAKE_DIAGONAL = SPR_G2_PIPELINE_TRACK_FLAT_DIAGONAL + 6,
    SPR_G2_PIPELINE_TRACK_BLOCK_BRAKE_DIAGONAL = SPR_G2_PIPELINE_TRACK_BRAKE_DIAGONAL + 6,
    SPR_G2_PIPELINE_TRACK_GENTLE_DIAGONAL = SPR_G2_PIPELINE_TRACK_BLOCK_BRAKE_DIAGONAL + 6,
    SPR_G2_PIPELINE_TRACK_STEEP_DIAGONAL = SPR_G2_PIPELINE_TRACK_GENTLE_DIAGONAL + 18,
    SPR_G2_PIPELINE_TRACK_BANK_TRANSITION = SPR_G2_PIPELINE_TRACK_STEEP_DIAGONAL + 18,
    SPR_G2_PIPELINE_TRACK_BANK_TRANSITION_DIAGONAL = SPR_G2_PIPELINE_TRACK_BANK_TRANSITION + 56,
    SPR_G2_PIPELINE_TRACK_SMALL_CURVE_BANKED = SPR_G2_PIPELINE_TRACK_BANK_TRANSITION_DIAGONAL + 56,
    SPR_G2_PIPELINE_TRACK_MEDIUM_CURVE_BANKED = SPR_G2_PIPELINE_TRACK_SMALL_CURVE_BANKED + 24,
    SPR_G2_PIPELINE_TRACK_LARGE_CURVE_BANKED = SPR_G2_PIPELINE_TRACK_MEDIUM_CURVE_BANKED + 40,
    SPR_G2_PIPELINE_TRACK_GENTLE_SMALL_CURVE = SPR_G2_PIPELINE_TRACK_LARGE_CURVE_BANKED + 64,
    SPR_G2_PIPELINE_TRACK_GENTLE_MEDIUM_CURVE = SPR_G2_PIPELINE_TRACK_GENTLE_SMALL_CURVE + 32,
    SPR_G2_PIPELINE_TRACK_STEEP_SMALL_CURVE = SPR_G2_PIPELINE_TRACK_GENTLE_MEDIUM_CURVE + 80,
    SPR_G2_PIPELINE_TRACK_S_BEND = SPR_G2_PIPELINE_TRACK_STEEP_SMALL_CURVE + 16,
    SPR_G2_PIPELINE_TRACK_SMALL_HELIX = SPR_G2_PIPELINE_TRACK_S_BEND + 32,
    SPR_G2_PIPELINE_TRACK_LARGE_HELIX = SPR_G2_PIPELINE_TRACK_SMALL_HELIX + 48,
    SPR_G2_PIPELINE_TRACK_INLINE_TWIST = SPR_G2_PIPELINE_TRACK_LARGE_HELIX + 80,
    SPR_G2_PIPELINE_TRACK_HALF_LOOP = SPR_G2_PIPELINE_TRACK_INLINE_TWIST + 48,
    SPR_G2_PIPELINE_TRACK_FLAT_TO_STEEP = SPR_G2_PIPELINE_TRACK_HALF_LOOP + 32,
    SPR_G2_PIPELINE_TRACK_TURN_BANK_TRANSITION = SPR_G2_PIPELINE_TRACK_FLAT_TO_STEEP + 64,
    SPR_G2_PIPELINE_TRACK_GENTLE_LARGE_CURVE = SPR_G2_PIPELINE_TRACK_TURN_BANK_TRANSITION + 32,

    SPR_G2_PIPELINE_LIFT_TRACK_FLAT = SPR_G2_PIPELINE_TRACK_GENTLE_LARGE_CURVE + 128,
    SPR_G2_PIPELINE_LIFT_TRACK_GENTLE = SPR_G2_PIPELINE_LIFT_TRACK_FLAT + 8,
    SPR_G2_PIPELINE_LIFT_TRACK_FLAT_DIAGONAL = SPR_G2_PIPELINE_LIFT_TRACK_GENTLE + 24,
    SPR_G2_PIPELINE_LIFT_TRACK_GENTLE_DIAGONAL = SPR_G2_PIPELINE_LIFT_TRACK_FLAT_DIAGONAL + 6,
    SPR_G2_PIPELINE_END = SPR_G2_PIPELINE_LIFT_TRACK_GENTLE_DIAGONAL + 18,
    SPR_G2_END = SPR_G2_PIPELINE_END,
