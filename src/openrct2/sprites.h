...
enum
{
    ...
    SPR_G2_TOOLBAR_MULTIPLAYER = SPR_G2_BEGIN + 122,
    SPR_G2_TOOLBAR_MULTIPLAYER_PRESSED = SPR_G2_BEGIN + 123,
    ...
    SPR_G2_MULTILOOPING_BEGIN = SPR_G2_SUPPORT_END,
    SPR_G2_MULTILOOPING_TRACK_FLAT = SPR_G2_MULTILOOPING_BEGIN,
    SPR_G2_MULTILOOPING_TRACK_BRAKE = SPR_G2_MULTILOOPING_BEGIN+2,
    SPR_G2_MULTILOOPING_TRACK_BLOCK_BRAKE = SPR_G2_MULTILOOPING_BEGIN+4,
    SPR_G2_MULTILOOPING_TRACK_BOOSTER = SPR_G2_MULTILOOPING_BEGIN+6,
    SPR_G2_MULTILOOPING_TRACK_GENTLE = SPR_G2_MULTILOOPING_BEGIN+8,
    SPR_G2_MULTILOOPING_TRACK_STEEP = SPR_G2_MULTILOOPING_BEGIN+20,
    SPR_G2_MULTILOOPING_TRACK_VERTICAL = SPR_G2_MULTILOOPING_BEGIN+36,
    SPR_G2_MULTILOOPING_TRACK_SMALL_CURVE = SPR_G2_MULTILOOPING_BEGIN+48,
    SPR_G2_MULTILOOPING_TRACK_MEDIUM_CURVE = SPR_G2_MULTILOOPING_BEGIN+60,
    SPR_G2_MULTILOOPING_TRACK_LARGE_CURVE = SPR_G2_MULTILOOPING_BEGIN+80,

    SPR_G2_MULTILOOPING_TRACK_FLAT_DIAGONAL = SPR_G2_MULTILOOPING_BEGIN+112,
    SPR_G2_MULTILOOPING_TRACK_GENTLE_DIAGONAL = SPR_G2_MULTILOOPING_BEGIN+116,
    SPR_G2_MULTILOOPING_TRACK_STEEP_DIAGONAL = SPR_G2_MULTILOOPING_BEGIN+128,

    SPR_G2_MULTILOOPING_TRACK_BANK_TRANSITION = SPR_G2_MULTILOOPING_BEGIN+140,
    SPR_G2_MULTILOOPING_TRACK_BANK_TRANSITION_DIAGONAL = SPR_G2_MULTILOOPING_BEGIN+180,
    SPR_G2_MULTILOOPING_TRACK_SMALL_CURVE_BANKED = SPR_G2_MULTILOOPING_BEGIN+214,
    SPR_G2_MULTILOOPING_TRACK_MEDIUM_CURVE_BANKED = SPR_G2_MULTILOOPING_BEGIN+228,
    SPR_G2_MULTILOOPING_TRACK_LARGE_CURVE_BANKED = SPR_G2_MULTILOOPING_BEGIN+250,

    SPR_G2_MULTILOOPING_TRACK_GENTLE_SMALL_CURVE = SPR_G2_MULTILOOPING_BEGIN+282,
    SPR_G2_MULTILOOPING_TRACK_GENTLE_MEDIUM_CURVE = SPR_G2_MULTILOOPING_BEGIN+298,
    SPR_G2_MULTILOOPING_TRACK_STEEP_SMALL_CURVE = SPR_G2_MULTILOOPING_BEGIN+338,
    SPR_G2_MULTILOOPING_TRACK_VERTICAL_TWIST = SPR_G2_MULTILOOPING_BEGIN+354,

    SPR_G2_MULTILOOPING_TRACK_SLOPE_BANK_TRANSITION = SPR_G2_MULTILOOPING_BEGIN+366,
    SPR_G2_MULTILOOPING_TRACK_GENTLE_SMALL_CURVE_BANKED = SPR_G2_MULTILOOPING_BEGIN+430,
    SPR_G2_MULTILOOPING_TRACK_GENTLE_MEDIUM_CURVE_BANKED = SPR_G2_MULTILOOPING_BEGIN+446,
   
    SPR_G2_MULTILOOPING_TRACK_S_BEND = SPR_G2_MULTILOOPING_BEGIN+486,
    SPR_G2_MULTILOOPING_TRACK_SMALL_HELIX = SPR_G2_MULTILOOPING_BEGIN+502,
    SPR_G2_MULTILOOPING_TRACK_LARGE_HELIX = SPR_G2_MULTILOOPING_BEGIN+530,

    SPR_G2_MULTILOOPING_TRACK_BARREL_ROLL = SPR_G2_MULTILOOPING_BEGIN+574,
    SPR_G2_MULTILOOPING_TRACK_HALF_LOOP = SPR_G2_MULTILOOPING_BEGIN+574+48,
    SPR_G2_MULTILOOPING_TRACK_FLAT_TO_STEEP = SPR_G2_MULTILOOPING_BEGIN+574+48+16,
    SPR_G2_MULTILOOPING_TRACK_QUARTER_LOOP = SPR_G2_MULTILOOPING_BEGIN+574+48+16+32,
    SPR_G2_MULTILOOPING_TRACK_CORKSCREW = SPR_G2_MULTILOOPING_BEGIN+574+48+16+32+12,
    SPR_G2_MULTILOOPING_TRACK_TURN_BANK_TRANSITION = SPR_G2_MULTILOOPING_BEGIN+574+48+16+32+12+24,
    SPR_G2_MULTILOOPING_TRACK_POWERED_LIFT = SPR_G2_MULTILOOPING_BEGIN+574+48+16+32+24+12+18,

    SPR_G2_MULTILOOPING_LIFT_BEGIN = SPR_G2_MULTILOOPING_BEGIN+574+48+16+32+24+12+18+4,
    SPR_G2_MULTILOOPING_LIFT_TRACK_FLAT = SPR_G2_MULTILOOPING_LIFT_BEGIN,
    SPR_G2_MULTILOOPING_LIFT_TRACK_GENTLE = SPR_G2_MULTILOOPING_LIFT_BEGIN+4,
    SPR_G2_MULTILOOPING_LIFT_TRACK_STEEP = SPR_G2_MULTILOOPING_LIFT_BEGIN+16,
   
    SPR_G2_MULTILOOPING_LIFT_TRACK_FLAT_DIAGONAL = SPR_G2_MULTILOOPING_LIFT_BEGIN+32,
    SPR_G2_MULTILOOPING_LIFT_TRACK_GENTLE_DIAGONAL = SPR_G2_MULTILOOPING_LIFT_BEGIN+36,
    SPR_G2_MULTILOOPING_LIFT_TRACK_STEEP_DIAGONAL = SPR_G2_MULTILOOPING_LIFT_BEGIN+48,
    SPR_G2_MULTILOOPING_END = SPR_G2_MULTILOOPING_LIFT_BEGIN+60,
    
    SPR_RIDE_DESIGN_PREVIEW_MULTILOOPING_ROLLER_COASTER_TRACK = SPR_G2_PLACEHOLDER,    //TODO: make sprites for preview
    SPR_RIDE_DESIGN_PREVIEW_MULTILOOPING_ROLLER_COASTER_SUPPORTS = SPR_G2_PLACEHOLDER,

    SPR_G2_END = SPR_G2_MULTILOOPING_END,
