...
enum : ImageIndex
{
    ...
    SPR_G2_PIPELINE_TRACK_GENTLE_DIAGONAL = SPR_G2_PIPELINE_TRACK_FLAT_DIAGONAL + 6,
    ...
    SPR_G2_PIPELINE_TRACK_SMALL_HELIX = SPR_G2_PIPELINE_TRACK_STEEP_SMALL_CURVE + 16,
...
/*
    SPR_G2_PIPELINE_TRACK_SLOPE_BANK_TRANSITION = SPR_G2_PIPELINE_BEGIN + 366,
    SPR_G2_PIPELINE_TRACK_GENTLE_SMALL_CURVE_BANKED = SPR_G2_PIPELINE_BEGIN + 430,
    SPR_G2_PIPELINE_TRACK_GENTLE_MEDIUM_CURVE_BANKED = SPR_G2_PIPELINE_BEGIN + 446,

    SPR_G2_PIPELINE_TRACK_S_BEND = SPR_G2_PIPELINE_BEGIN + 486,
    SPR_G2_PIPELINE_TRACK_TURN_BANK_TRANSITION = SPR_G2_PIPELINE_BEGIN + 706,
*/
    SPR_G2_PIPELINE_LIFT_TRACK_FLAT = SPR_G2_PIPELINE_TRACK_HALF_LOOP + 32,
