...
#define WC_TOP_TOOLBAR__WIDX_POOL 26
...
#define WC_TILE_INSPECTOR__TILE_INSPECTOR_PAGE_POOL TileInspectorPage::Pool
#define WC_TILE_INSPECTOR__WIDX_POOL_SPINNER_HEIGHT_INCREASE 27
#define WC_TILE_INSPECTOR__WIDX_POOL_SPINNER_HEIGHT_DECREASE 28
