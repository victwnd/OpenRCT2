...
enum : uint16_t
{
    ...
    STR_POOLS = 6506,
    STR_POOL_IN_THE_WAY = 6507,
    STR_CANT_BUILD_POOL_HERE = 6508,
    STR_CANT_REMOVE_POOL_FROM_HERE = 6509,
    STR_BUILD_POOL_TIP = 6510,
    STR_POOL_TIP = 6511,
    STR_CORNER_STYLE=6512,
    STR_POOL_SQUARE_TIP = 6513,
    STR_POOL_ANGLED_TIP = 6514,
    STR_POOL_ROUNDED_TIP = 6515,
    STR_POOL_PATH_TIP = 6516,
    STR_POOL_WATER_TIP = 6517,
    STR_POOL_RECTANGLE_TIP = 6518,
    STR_POOL_DEPTH = 6519,
